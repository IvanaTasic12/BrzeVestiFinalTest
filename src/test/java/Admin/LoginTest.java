...
public class LoginTest {
    ...
    public static void setUpClass() {
        System.setProperty("webdriver.chrome.driver", "/Users/Tasic/desktop/workspace/BrzeVestiFinalTest/chromedriver.exe");
...
//        assertTrue("URL doesn't match",expectedResult.equals(actualResult));
